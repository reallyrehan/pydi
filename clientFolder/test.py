...
#serverDict = {'myName':'sv1','server1':'sv2','server2':'sv3'}
...
def serverComm(threadName,delay,fSock,addr,nameSERVER):
    ...
    if(p[0]=='startup'):
        ...
        if(p[0]=='incoming'):
            spList = [serverDict['myName'],serverDict['server1']]
            binaryN = bNameCount
